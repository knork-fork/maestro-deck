...
const MENUS = [
  {
    ...
    items: [
      ...
      { sep: true },
      { label: 'Clear Current Project', action: isMainArea ? () => window.dispatchEvent(new CustomEvent('md-clear-project')) : null, disabled: !isMainArea },
      { label: 'Clear All Projects', action: () => window.dispatchEvent(new CustomEvent('md-clear-all-projects')) },
      { sep: true },
